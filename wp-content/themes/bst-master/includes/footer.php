<footer class="container site-footer">
  ...
  <div class="row">
    <div class="col-lg-12 site-sub-footer">
      ...
      <p>&copy; <?php echo date('Y'); ?> <a href="<?php echo home_url('/'); ?>"><?php bloginfo('name'); ?></a> - <a href="<?php echo get_permalink( get_page_by_title( 'Contact' ) ) ?>">Nous contacter</a> - <a href="http://slowvan.com/a-propos-de-nous/">A propos</a></p>
    </div>
  </div>
</footer>
